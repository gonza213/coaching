...
class ControllerUsuario
{
        ...
        if (isset($_POST["email"])) {
            ...
            if (preg_match('/^[a-zA-Z0-9]+$/', $_POST["password"])) {
                ...
                if ($respuesta["email"] == $_POST["email"] && $respuesta["password"] == $encriptar ) {
                    ...
                    echo "<br><br><div class='alert alert-danger'>Error al ingresar, vuelve a intentar</div>";
                }
            }
        }
    }
    ...
    static public function ctrMostrarUsuarios()
    {
        ...
        $respuesta = ModelUsuario::mdlMostrarAdmin($tabla);
    ...
    //             $respuesta = ModelUsuario::mdlCrearAdmin($tabla, $datos);
    ...
    static public function ctrEditarUsuario()
    {
        ...
        if (isset($_POST["usuarioE"])) {
            ...
            if (preg_match('/^[a-zA-Z0-9]+$/', $_POST["idE"])) {
                ...
                $respuesta = ModelUsuario::mdlEditarAdmin($tabla, $datos);
    ...
    static public function ctrBorrarUsuario()
    {
        ...
        if (isset($_GET["idBorrarUsuario"])) {
            ...
            $respuesta = ModelUsuario::mdlBorrarAdmin($tabla, $datos);
    ...
    static public function ctrVerUsuario($item, $valor)
    {
        ...
        $resultado = ModelUsuario::mdlVerAdmin($tabla, $item, $valor);
